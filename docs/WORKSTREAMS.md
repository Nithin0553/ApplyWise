...
The first development tranche is intentionally limited to six parallel workstreams. Detailed work is tracked by GitHub issues; this document records the ownership intent.

- Nithin (`@Nithin0553`): F02 evidence foundation + early F13 snapshot model.
- Niraali (`@niraalibandi`): F07 grounded generation/provenance contract.
